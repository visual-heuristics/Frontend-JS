  ...
  visualStages: [
    {
      visualSprites: [
        ...
        },
        {
          ...
          x: 0,
          y: 100,
          color: { r: 0.6902, g: 0.7765, b: 0.3922, a: 1.0 },
          width: 80,
          height: 80,
          depth: 1,
          name: "node0-1",
        ...
        },
        {
          ...
          x: 200,
          y: 200,
          color: { r: 0.9804, g: 0.6353, b: 0.7098, a: 1.0 },
          width: 80,
          height: 80,
          depth: 1,
          name: "node2-2",
        ...
        },
        {
          ...
          x: 205,
          y: 305,
          color: { r: 0.0784, g: 0.6471, b: 0.8588, a: 1.0 },
          width: 20,
          height: 20,
          depth: 3,
          name: "key0",
    ...
    },
    {
      ...
      stageName: "(move node2-4 node1-4)",
      stageInfo:
        "(:action move\r\n    :parameters (node2-4 node1-4)\r\n    :precondition\r\n      (and\r\n        (place node2-4)\r\n        (place node1-4)\r\n        (at-robot node2-4)\r\n        (conn node2-4 node1-4)\r\n        (open node1-4)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-4)\r\n        (not\r\n          (at-robot node2-4)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node1-4 node0-4)",
      stageInfo:
        "(:action move\r\n    :parameters (node1-4 node0-4)\r\n    :precondition\r\n      (and\r\n        (place node1-4)\r\n        (place node0-4)\r\n        (at-robot node1-4)\r\n        (conn node1-4 node0-4)\r\n        (open node0-4)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node0-4)\r\n        (not\r\n          (at-robot node1-4)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node0-4 node0-3)",
      stageInfo:
        "(:action move\r\n    :parameters (node0-4 node0-3)\r\n    :precondition\r\n      (and\r\n        (place node0-4)\r\n        (place node0-3)\r\n        (at-robot node0-4)\r\n        (conn node0-4 node0-3)\r\n        (open node0-3)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node0-3)\r\n        (not\r\n          (at-robot node0-4)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node0-3 node0-2)",
      stageInfo:
        "(:action move\r\n    :parameters (node0-3 node0-2)\r\n    :precondition\r\n      (and\r\n        (place node0-3)\r\n        (place node0-2)\r\n        (at-robot node0-3)\r\n        (conn node0-3 node0-2)\r\n        (open node0-2)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node0-2)\r\n        (not\r\n          (at-robot node0-3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(pickup node0-2 key3)",
      stageInfo:
        "(:action pickup\r\n    :parameters (node0-2 key3)\r\n    :precondition\r\n      (and\r\n        (place node0-2)\r\n        (key key3)\r\n        (at-robot node0-2)\r\n        (at key3 node0-2)\r\n        (arm-empty)\r\n      )\r\n    :effect\r\n      (and\r\n        (holding key3)\r\n        (not\r\n          (at key3 node0-2)\r\n        )\r\n        (not\r\n          (arm-empty)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node0-2 node1-2)",
      stageInfo:
        "(:action move\r\n    :parameters (node0-2 node1-2)\r\n    :precondition\r\n      (and\r\n        (place node0-2)\r\n        (place node1-2)\r\n        (at-robot node0-2)\r\n        (conn node0-2 node1-2)\r\n        (open node1-2)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-2)\r\n        (not\r\n          (at-robot node0-2)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node1-2 node1-3)",
      stageInfo:
        "(:action move\r\n    :parameters (node1-2 node1-3)\r\n    :precondition\r\n      (and\r\n        (place node1-2)\r\n        (place node1-3)\r\n        (at-robot node1-2)\r\n        (conn node1-2 node1-3)\r\n        (open node1-3)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-3)\r\n        (not\r\n          (at-robot node1-2)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(unlock node1-3 node2-3 key3 square)",
      stageInfo:
        "(:action unlock\r\n    :parameters (node1-3 node2-3 key3 square)\r\n    :precondition\r\n      (and\r\n        (place node1-3)\r\n        (place node2-3)\r\n        (key key3)\r\n        (shape square)\r\n        (conn node1-3 node2-3)\r\n        (key-shape key3 square)\r\n        (lock-shape node2-3 square)\r\n        (at-robot node1-3)\r\n        (locked node2-3)\r\n        (holding key3)\r\n      )\r\n    :effect\r\n      (and\r\n        (open node2-3)\r\n        (not\r\n          (locked node2-3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(putdown node1-3 key3)",
      stageInfo:
        "(:action putdown\r\n    :parameters (node1-3 key3)\r\n    :precondition\r\n      (and\r\n        (place node1-3)\r\n        (key key3)\r\n        (at-robot node1-3)\r\n        (holding key3)\r\n      )\r\n    :effect\r\n      (and\r\n        (arm-empty)\r\n        (at key3 node1-3)\r\n        (not\r\n          (holding key3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node1-3 node2-3)",
      stageInfo:
        "(:action move\r\n    :parameters (node1-3 node2-3)\r\n    :precondition\r\n      (and\r\n        (place node1-3)\r\n        (place node2-3)\r\n        (at-robot node1-3)\r\n        (conn node1-3 node2-3)\r\n        (open node2-3)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node2-3)\r\n        (not\r\n          (at-robot node1-3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(pickup node2-3 key0)",
      stageInfo:
        "(:action pickup\r\n    :parameters (node2-3 key0)\r\n    :precondition\r\n      (and\r\n        (place node2-3)\r\n        (key key0)\r\n        (at-robot node2-3)\r\n        (at key0 node2-3)\r\n        (arm-empty)\r\n      )\r\n    :effect\r\n      (and\r\n        (holding key0)\r\n        (not\r\n          (at key0 node2-3)\r\n        )\r\n        (not\r\n          (arm-empty)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node2-3 node1-3)",
      stageInfo:
        "(:action move\r\n    :parameters (node2-3 node1-3)\r\n    :precondition\r\n      (and\r\n        (place node2-3)\r\n        (place node1-3)\r\n        (at-robot node2-3)\r\n        (conn node2-3 node1-3)\r\n        (open node1-3)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-3)\r\n        (not\r\n          (at-robot node2-3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node1-3 node1-2)",
      stageInfo:
        "(:action move\r\n    :parameters (node1-3 node1-2)\r\n    :precondition\r\n      (and\r\n        (place node1-3)\r\n        (place node1-2)\r\n        (at-robot node1-3)\r\n        (conn node1-3 node1-2)\r\n        (open node1-2)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-2)\r\n        (not\r\n          (at-robot node1-3)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(move node1-2 node1-1)",
      stageInfo:
        "(:action move\r\n    :parameters (node1-2 node1-1)\r\n    :precondition\r\n      (and\r\n        (place node1-2)\r\n        (place node1-1)\r\n        (at-robot node1-2)\r\n        (conn node1-2 node1-1)\r\n        (open node1-1)\r\n      )\r\n    :effect\r\n      (and\r\n        (at-robot node1-1)\r\n        (not\r\n          (at-robot node1-2)\r\n        )\r\n      )\r\n  )",
      isFinal: "false",
    },
    {
      visualSprites: [
      ...
      stageName: "(putdown node1-1 key0)",
      stageInfo:
        "(:action putdown\r\n    :parameters (node1-1 key0)\r\n    :precondition\r\n      (and\r\n        (place node1-1)\r\n        (key key0)\r\n        (at-robot node1-1)\r\n        (holding key0)\r\n      )\r\n    :effect\r\n      (and\r\n        (arm-empty)\r\n        (at key0 node1-1)\r\n        (not\r\n          (holding key0)\r\n        )\r\n      )\r\n  )",
      isFinal: "true",
    },
  ],
  subgoalPool: {
    m_keys: ["(at key0 node1-1 )"],
    m_values: [["key0", "node1-1"]],
  },
  subgoalMap: { m_keys: [15], m_values: [["(at key0 node1-1 )"]] },
  transferType: 1,
  imageTable: {
    m_keys: [
      "img-circle",
