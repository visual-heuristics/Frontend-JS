...
; Documentation about Animation Profile syntax: https://planimation.github.io/documentation/ap_guide/
; More animation Profiles available at https://github.com/planimation/documentation/tree/master/AnimationProfiles
; BlocksWorld Domain available at https://github.com/AI-Planning/classical-domains/tree/master/classical/blocks
 ...
 ; Specifies one object is on top of the other
  (:predicate on
                 ...
                 :effect(
                 (equal (?b1 x) (?b2 x))
                 (equal (?b1 y) (add (?b2 y) (?b2 height) 2))
                 )
  )
...
; Specifies an object is on the table
  (:predicate ontable
                 :parameters (?b)
                 :effect(
                 (assign (?b x) (function distributex (objects ?b) (settings (spacebtwn 40))))
                 (equal (?b y) 0)
                 )
   )
